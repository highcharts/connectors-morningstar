...
export async function riskStatisticsLoad (
    ...
    Assert.deepStrictEqual(
        ...
        [
            'GbPostTax_MonthEnd_Alphas',
            'GbPostTax_MonthEnd_Betas',
            'GbPostTax_MonthEnd_InformationRatios',
            'GbPostTax_MonthEnd_RSquareds',
            'GbPostTax_MonthEnd_SharpeRatios',
            'GbPostTax_MonthEnd_StandardDeviations',
            'GbPostTax_MonthEnd_TrackingErrors',
            'ItPostTax_MonthEnd_Alphas',
            'ItPostTax_MonthEnd_Betas',
            'ItPostTax_MonthEnd_InformationRatios',
            'ItPostTax_MonthEnd_RSquareds',
            'ItPostTax_MonthEnd_SharpeRatios',
            'ItPostTax_MonthEnd_StandardDeviations',
            'ItPostTax_MonthEnd_TrackingErrors',
            'Nav_MonthEnd_Alphas',
            'Nav_MonthEnd_Betas',
            'Nav_MonthEnd_InformationRatios',
            'Nav_MonthEnd_RSquareds',
            'Nav_MonthEnd_SharpeRatios',
