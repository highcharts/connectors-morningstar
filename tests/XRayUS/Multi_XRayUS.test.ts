...
export async function multiXRayUSConnectorLoad (
    ...
    const actualTrailingReturnsColumns = connector.dataTables.TrailingReturns.getColumnIds();
    ...
    const expectedAssetAllocationsColumns = [
        'L_0P000000GY_TestPortfolio1',
        'L_0P000000GY_TestPortfolio2',
        ...
        'L_TestPortfolio1',
        'L_TestPortfolio2',
        'N_0P000000GY_TestPortfolio1',
        'N_0P000000GY_TestPortfolio2',
        ...
        'N_TestPortfolio1',
        'N_TestPortfolio2',
        'S_0P000000GY_TestPortfolio1',
        'S_0P000000GY_TestPortfolio2',
    ...
    const expectedRiskStatisticsColumns = [
        ...
        'Mean_0P000000GY_TestPortfolio1',
        'Mean_0P000000GY_TestPortfolio2',
        ...
        'StandardDeviation_0P000000GY_TestPortfolio1',
        'StandardDeviation_0P000000GY_TestPortfolio2',
        ...
        'TrailingTimePeriod',
        'Weight_0P000000GY_TestPortfolio1',
        'Weight_0P000000GY_TestPortfolio2',
    ...
    const expectedCorrelationMatrixColumns = [
        'Year10_0P000000GY_TestPortfolio1',
        'Year10_0P000000GY_TestPortfolio2',
        ...
        'Year10_TestPortfolio1',
        'Year10_TestPortfolio2',
        'Year3_0P000000GY_TestPortfolio1',
        'Year3_0P000000GY_TestPortfolio2',
        ...
        'Year3_TestPortfolio1',
        'Year3_TestPortfolio2',
        'Year5_0P000000GY_TestPortfolio1',
        'Year5_0P000000GY_TestPortfolio2',
