...
- multiple categories (comma-separated file names or folders): `npm run test -- --tests GoalAnalysis,RiskScore,Screeners,SecurityCompare,SecurityDetails,Shared,TimeSeries,XRay`
